...
## 二. CBAM的网络结构
### 2.1. 总体的描述
<font   color=black> 对于一个中间层的Feature map \begin{equation}
\mathbf{F} \in \mathbb{R}^{C \times H \times W}
\end{equation}，CBAM将会顺序推理出1维的channel attention map $\mathbf M_{c} \in \mathbb{R}^{C  \times 1  \times 1}$ 以及2维的spatial attention map $\mathbf M_{s} \in \mathbb{R}^{1 \times H  \times W}$，整个过程如下所示：
<font color=black> $$
...
<center><image src="https://img-blog.csdnimg.cn/201912301438348.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2FiYzEzNTI2MjIyMTYw,size_16,color_FFFFFF,t_70" width="75%">
